...
% === Quantise chaotic signal ===
chaotic_signal_enc(chaotic_signal_enc > 0) = floor(chaotic_signal_enc(chaotic_signal_enc > 0) * 10) / 10;
chaotic_signal_enc(chaotic_signal_enc < 0 & chaotic_signal_enc > -0.1) = 0;
chaotic_signal_enc(chaotic_signal_enc <= -0.1) = floor(chaotic_signal_enc(chaotic_signal_enc <= -0.1) * 10) / 10;
...
% === Quantise chaotic signal ===
chaotic_signal_dec(chaotic_signal_dec > 0) = floor(chaotic_signal_dec(chaotic_signal_dec > 0) * 10) / 10;
chaotic_signal_dec(chaotic_signal_dec < 0 & chaotic_signal_dec > -0.1) = 0;
chaotic_signal_dec(chaotic_signal_dec <= -0.1) = floor(chaotic_signal_dec(chaotic_signal_dec <= -0.1) * 10) / 10;
